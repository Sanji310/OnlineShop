	...
	<div class="header">
			...
			<div class="header-top-in">			
				...
				<div class="header-in">
					<ul class="icon1 sub-icon1">
							...
							<li ><a href="#" >CART</a></li>
							<li > <a href="checkout.jsp" >PAY</a> </li>	
							<li><div class="cart">
						  ...
						  <div class="shopping_cart">
                            ...
                            <div class="login_buttons">
							  <div class="check_button"><a href="checkout.jsp">Pay</a></div>
							  <div class="clearfix"></div>
						    </div>
					      <div class="clearfix"></div>
						</ul>
		...
		<div class="container">
			<div class="h_menu4">
				...
				<ul class="nav">
					<li class="active"><a href="Index.jsp"><i> </i>HOME PAGE</a></li>
					<li ><a href="#" >PRODUCT</a>
						<ul class="drop">
                                                    <% 
		...
		<div class="header-bottom-in">
			...
			<p class="wel"><a href="Register.jsp">Do not have an account. Sign up now!</a></p>
