    ...
    <body>
        ...
        %>
                    ...
                    <div class="content-top"> <div class="future">
                            <h3 class="bn-catalog-title">NEW PHONE</h3></div>
                                ...
                                <div class="col-md">
                                   <a href="Single.jsp?product=<%=p.getProductID()%>"><img src="<%=p.getProductImage()%>" alt="<%=p.getProductName()%>"/></a>	
                                    <div class="top-content">
                                        ...
                                        <div class="white">
                                            <a href="CartServlet?command=plus&productID=<%=p.getProductID()%>" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">ADD TO BASKET</a>
